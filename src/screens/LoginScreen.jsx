...
export default function LoginScreen({ onSkip }) {
  ...
  return (
    <div className="flex flex-col h-full bg-white items-center justify-center px-8">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-2 slide-up">Welcome to Urban Company</h1>
      <p className="text-sm text-gray-500 text-center mb-8 leading-relaxed slide-up">
      ...
      <div className="w-full space-y-3 slide-up">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border border-gray-200 bg-white text-gray-900 font-semibold text-sm active:opacity-70 transition-opacity"
        >
      ...
      <button
        onClick={onSkip}
        className="mt-6 text-sm text-gray-500 active:opacity-60 transition-opacity"
      >
        Skip for now →
      </button>
    </div>
