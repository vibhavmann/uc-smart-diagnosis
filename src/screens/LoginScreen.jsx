...
export default function LoginScreen({ onSkip }) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-900 items-center justify-center px-8">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-8 leading-relaxed slide-up">
      ...
      <div className="w-full space-y-3 slide-up">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-semibold text-sm active:opacity-70 transition-opacity"
        >
      ...
      <button
        onClick={onSkip}
        className="mt-6 text-sm text-gray-400 dark:text-gray-500 active:opacity-60 transition-opacity"
      >
        Skip for now →
      </button>
    </div>
