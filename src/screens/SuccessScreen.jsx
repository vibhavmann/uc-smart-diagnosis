...
export default function SuccessScreen({ result, slot, onHome }) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#241847] items-center justify-center px-6 text-center">
      ...
      <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2 slide-up">Booking Confirmed!</h1>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 leading-relaxed slide-up">
        Your <strong className="text-gray-900 dark:text-white">{result.service}</strong> is booked.
