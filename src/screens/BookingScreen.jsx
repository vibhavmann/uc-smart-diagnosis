  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 scroll-hide px-4 pt-4 pb-4 space-y-4">
        <div className="rounded-2xl p-4 border border-gray-200" style={{ background: 'var(--c-icon-bg)' }}>
        ...
        <div>
          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Saved Address</p>
        ...
        <div>
          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Choose a Slot</p>
            ...
            {SLOTS.map((s, i) => (
              ...
              >
                <span
                  ...
                  style={{ color: slot === i && s.ok ? '#fff' : undefined }}
                >
                  {s.day}
                </span>
