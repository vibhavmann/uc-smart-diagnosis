    ...
    return (
      <div className="flex flex-col h-full bg-white">
        ...
        <div className="flex-1 scroll-hide px-4 pt-6 pb-6">
          <div className="rounded-2xl p-5 mb-5 slide-up border border-gray-200" style={{ background: 'var(--c-icon-bg)' }}>
          ...
          <div className="flex flex-col gap-3">
            {(result.clarifyingOptions || []).map((opt, i) => (
              <button
                key={opt}
                className="w-full text-left py-3.5 px-4 rounded-2xl border text-sm font-medium text-gray-800 bg-white slide-up"
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: 'var(--c-bg)' }}>
      ...
      <div className="flex-1 scroll-hide px-4 pt-3 pb-3 space-y-3">
        ...
        {/* price band */}
        <div className="bg-white rounded-2xl p-4 border border-gray-200 slide-up" style={{ animationDelay: '60ms' }}>
          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Realistic Price Estimate</p>
        ...
        {/* Add more detail */}
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden slide-up" style={{ animationDelay: '100ms' }}>
          <button
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-gray-900">Not quite right? Add more detail</span>
            </div>
            <span className="text-gray-500 text-sm">{showAddDetail ? '▲' : '▼'}</span>
          </button>
          {showAddDetail && (
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden slide-up" style={{ animationDelay: '140ms' }}>
          <button className="w-full flex items-center justify-between px-4 py-3.5" onClick={() => setOpenBA(!openBA)}>
            ...
            <span className="text-gray-500 text-sm">{openBA ? '▲' : '▼'}</span>
          </button>
          {openBA && (
            <div className="px-3 pb-4 fade-in">
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div className="bg-gray-50 rounded-xl p-3">
                  <p className="text-[11px] font-bold text-gray-700 mb-2">✅ New Path</p>
                  {['User describes problem', 'AI routes correctly', 'Right pro dispatched', 'Honest price upfront', 'No surprises', 'First-visit success', '5-star review'].map((t) => (
                    <p key={t} className="text-[11px] text-gray-700 leading-snug mt-1">{t}</p>
                  ))}
                </div>
              </div>
            </div>
        ...
        {/* impact */}
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden slide-up" style={{ animationDelay: '180ms' }}>
          <button className="w-full flex items-center justify-between px-4 py-3.5" onClick={() => setOpenImpact(!openImpact)}>
            <div className="flex items-center gap-2">
              ...
              <Badge variant="gray">Illustrative</Badge>
            </div>
            <span className="text-gray-500 text-sm">{openImpact ? '▲' : '▼'}</span>
          </button>
          {openImpact && (
            <div className="px-3 pb-4 fade-in grid grid-cols-2 gap-2.5">
              {[
                ...
                { val: '₹280', label: 'Saved / booking', bg: 'bg-gray-50', color: 'text-gray-700' },
              ].map((m) => (
